...
def teste_incluir_pet():
    ...
    resultado_obtido = requests.post(
        url=url,
        headers=headers,
        data=open('C:\\Users\\franc\\PycharmProjects\\134inicial\\vendors\\json\\pet.1.json')
    )
...
def teste_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=url,
        headers=headers,
        data=open('C:\\Users\\corre\\PycharmProjects\\134inicial\\vendors\\json\\pet2.json')
    )
...
@pytest.mark.parametrizer('pet_id,category_id,category_name,pet_name,tags_id',
                          ler_csv('C:\\Users\\franc\\PycharmProjects\\134inicial\\vendors\\csv\\massa_incluir_pet.csv')
                          )
def teste_incluir_pet_em_massa(pet_id, category_id, category_name, pet_name, tags_id):
    # Configura
    status_code_esperado = 200
    corpo_json = '{'
    ...
    corpo_json += '      "name": "vacinado"'
    corpo_json += '    }'
    corpo_json += '  ],'
    corpo_json += '  "status": "{status}"'
    corpo_json += '}'
